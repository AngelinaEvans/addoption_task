...
class BasePage():
    ...
    def go_to_cart_page(self) -> object:
        cart_cta = self.browser.find_element(*MainPageLocators.REVIEW_MY_CART)
        cart_cta.click()
        assert "/basket/" in self.browser.current_url, f"/basket/ is not in current url"
...
# a = BasePage("Chrome", "https://stepic")
# print(type(open))
